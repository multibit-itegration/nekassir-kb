...
Отследить данные заказы можно через телеграмм-бот ([https://nekassir.gitbook.io/nekassir/admin-panel/terminaly/nastroiki-terminala/telegramm-bot](../../panel-administratora/terminaly/nastroiki-terminala/2.2.6.-telegramm-bot.md)) или в списке заказов ([https://nekassir.gitbook.io/nekassir/admin-panel/terminaly/zakazy](https://nekassir.gitbook.io/nekassir/admin-panel/terminaly/zakazy)) в статусе Ошибка создания&#x20;
...
| Заказ был отправлен в режиме таб мод, в терминальной группе не включено использование табов | Marking order as a tab supported only in tab mode. Check tab mode for terminals group "..."      | Заказ отправился в таб, но в группе не включена настройка "Использовать табы", починить сможет только ТП                                  |
